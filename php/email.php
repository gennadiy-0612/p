...
$mailSMTP = new SendMailSmtpClass('xapaktepnikzaporizhia@gmail.com', '2212197710', 'ssl://smtp.gmail.com', $_POST['name'], 465); // создаем экземпляр класса
// $mailSMTP = new SendMailSmtpClass('xo1@xo12017.com', '24.02.2017.xo1.com', 'ssl://smtp.gmail.com', 'Evgeniy', 465); // создаем экземпляр класса
// $mailSMTP = new SendMailSmtpClass('логин', 'пароль', 'хост', 'имя отправителя');

// заголовок письма
$headers = "MIME-Version: 1.0\r\n";
$headers .= "Content-type: text/html; charset=utf-8\r\n"; // кодировка письма
$headers .= "From: " . $_POST['name'] . " <" . $_POST['fromEmail'] . ">\r\n"; // от кого письмо
$result = $mailSMTP->send($_POST['toEmail'], 'gmail', $_POST['html'], $headers); // отправляем письмо
